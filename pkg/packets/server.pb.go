...
func (x *FromServerToClient) GetServerVersion() string {
	if x != nil {
...
type FromServerToClient_WebsocketId struct {
	WebsocketId *WebsocketIDResponse `protobuf:"bytes,10,opt,name=websocket_id,json=websocketId,proto3,oneof"`
}

type FromServerToClient_ErrorResponse struct {
	ErrorResponse *ErrorResponse `protobuf:"bytes,11,opt,name=error_response,json=errorResponse,proto3,oneof"`
}

type FromServerToClient_AuthenticationResponse struct {
	AuthenticationResponse *AuthenticationResponse `protobuf:"bytes,12,opt,name=authentication_response,json=authenticationResponse,proto3,oneof"`
}

type FromServerToClient_ChapterDataResponse struct {
	ChapterDataResponse *AccessibleChapterResponse `protobuf:"bytes,13,opt,name=chapter_data_response,json=chapterDataResponse,proto3,oneof"`
}

type FromServerToClient_EpisodeDataResponse struct {
	EpisodeDataResponse *AccessibleEpisodesResponse `protobuf:"bytes,14,opt,name=episode_data_response,json=episodeDataResponse,proto3,oneof"`
}

type FromServerToClient_DialogueTrigger struct {
	DialogueTrigger *DialogueTrigger `protobuf:"bytes,15,opt,name=dialogue_trigger,json=dialogueTrigger,proto3,oneof"`
}
...
const file_server_proto_rawDesc = "" +
	...
	"\fwebsocket_id\x18\n" +
	" \x01(\v2\x1c.packets.WebsocketIDResponseH\x00R\vwebsocketId\x12?\n" +
	"\x0eerror_response\x18\v \x01(\v2\x16.packets.ErrorResponseH\x00R\rerrorResponse\x12Z\n" +
	"\x17authentication_response\x18\f \x01(\v2\x1f.packets.AuthenticationResponseH\x00R\x16authenticationResponse\x12X\n" +

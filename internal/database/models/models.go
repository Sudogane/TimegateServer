...
type Achievement struct {
	...
	UnlockRequirementAmount pgtype.Int4 `json:"unlock_requirement_amount"`
	RequiredAchievementID   pgtype.Int4 `json:"required_achievement_id"`
	RequiredQuestID         pgtype.Int4 `json:"required_quest_id"`
